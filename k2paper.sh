...
##echo "COMPRESSED"
###echo "BUILDING"
###./k2bp_compr.x /data/matrix/webg/indochina-2004.mtx.rowm.k2bprrr
##echo "MULTIPLY"
...
echo "UK 2005"
#echo "BUILDING"
./k2bp_build.x /data/matrix/webg/in-2004.mtx.rowm 1382908 16917053
echo "MULTIPLY"
/usr/bin/time ./k2bp_mult_1.x /data/matrix/webg/in-2004.mtx.rowm.k2bprrr /data/matrix/webg/in-2004.mtx.rowm.k2bprrr
echo "--------------"
echo "BUILDING"
./k2bp_compr.x /data/matrix/webg/in-2004.mtx.rowm.k2bprrr
echo "MULTIPLY"
/usr/bin/time ./k2bp_compr_mult.x /data/matrix/webg/in-2004.mtx.rowm.k2bprrri /data/matrix/webg/in-2004.mtx.rowm.k2bprrri
echo "--------------"
